...
@media (max-width: 360px) {
  ...
  .btn-primary {
    font-size: 0.9rem; /* Ajuste de tamaño de fuente para botón */
  }
  ...
  .form-group select {
    font-size: 0.9rem; /* Ajuste de tamaño de fuente para selects */
  }
  ...
  .table th, .table td {
    font-size: 0.9rem; /* Ajuste de tamaño de fuente para la tabla */
  }
}
